...
"use strict";
 ...
 var app = angular.module('LodashImplementation', [
     'ngRoute'
 ]);
...
app.controller('HeaderController', ['$scope', function($scope) {
    ...
    $scope.options = ['Size', 'Includes', 'Sample', 'Sample size'];
...
app.controller('methodController', ['$rootScope', '$scope', 'methodService', function($rootScope, $scope, MethodService) {
...
app.factory('methodService', ['$rootScope', function($rootScope) {
    var methodModel = {};
    return {
