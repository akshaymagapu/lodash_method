...
describe('method', function() {
    ...
    var methodController, MethodService, scope, controller;

    beforeEach(inject(function($rootScope, _$controller_, _methodService_) {
        scope = $rootScope.$new();
    ...
    it('should check methods property is defined', function() {
        ...
        expect(scope.methods.length).toBe(4);
    });
